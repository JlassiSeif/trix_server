...
## Open
1. **Deploy (M5):** waiting for Seif's instructions. Drafts are ready: `docs/deploy.md`, `deploy/trix.service`, `deploy/Caddyfile`.
   Needed from Seif: the domain; the Oracle machine's shape (ARM A1 / AMD micro), OS and SSH access; whether anything already uses ports 80/443. The machine needs Node ≥ 22.12.
