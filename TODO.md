...
- [ ] **Question for Seif:** should room ownership pass to another player if the owner is away for a few minutes? Today a table whose owner never returns stays paused.
