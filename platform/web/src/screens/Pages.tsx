  ...
  en: {
    about: {
      ...
      sections: [
        ...
        { p: ["The card faces come from GNOME Aisleriot, free software under the GPL (version 3 or later)."] },
      ],
    },
    privacy: {
      title: "Privacy",
  ...
  fr: {
    about: {
      ...
      sections: [
        ...
        { p: ["Les faces des cartes viennent de GNOME Aisleriot, un logiciel libre sous licence GPL (version 3 ou ultérieure)."] },
      ],
    },
    privacy: {
  ...
  ar: {
    about: {
      ...
      sections: [
        ...
        { p: ["وجوه الأوراق مأخوذة من GNOME Aisleriot، وهو برنامج حر برخصة GPL (الإصدار 3 أو أحدث)."] },
      ],
    },
    privacy: {
      title: "الخصوصية",
