  ...
  en: {
    about: {
      ...
      sections: [
        ...
        { p: ["The card faces come from GNOME Aisleriot, free software under the GPL (version 3 or later). The Chkobba cards are drawn by Abjiklam (Wikimedia Commons): the pips are in the public domain (CC0), the faces are under CC BY-SA 4.0."] },
      ],
    },
    privacy: {
      title: "Privacy",
  ...
  fr: {
    about: {
      ...
      sections: [
        ...
        { p: ["Les faces des cartes viennent de GNOME Aisleriot, un logiciel libre sous licence GPL (version 3 ou ultérieure). Les cartes de Chkobba sont dessinées par Abjiklam (Wikimedia Commons) : les cartes de points sont dans le domaine public (CC0), les figures sous licence CC BY-SA 4.0."] },
      ],
    },
    privacy: {
  ...
  ar: {
    about: {
      ...
      sections: [
        ...
        { p: ["وجوه الأوراق مأخوذة من GNOME Aisleriot، وهو برنامج حر برخصة GPL (الإصدار 3 أو أحدث). أما أوراق Chkobba فمن رسم Abjiklam (ويكيميديا كومنز): أوراق الأرقام في الملك العام (CC0)، والصور برخصة CC BY-SA 4.0."] },
      ],
    },
    privacy: {
      title: "الخصوصية",
