...
//
//   TRIX_SPEED=10 PORT=8123 node platform/server/dist/index.js     (after npm run build)
//   node platform/web/e2e/play-vs-bots.mjs OUT_DIR [--base http://127.0.0.1:8123] [--viewport 390x844]
...
await shot("home");
await page.click('.game-card:has-text("Trix")');
